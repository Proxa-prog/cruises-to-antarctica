...
var navLi = document.querySelectorAll('.header__nav-item');
var buttonsInCard = document.querySelectorAll(".cruise-catalog__item a");

var navOpen = function navOpen() {
  headerNavList.classList.add('nav-list--closed');
  nav.classList.remove('is-open');
  nav.classList.remove('nav-list--no-js');
  Object.keys(buttonsInCard).forEach(function (index) {
    buttonsInCard[index].addEventListener("click", function (e) {
      e.preventDefault();
    });
  });
  ...
  var _iterator = _createForOfIteratorHelper(navLi),
      _step;

  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var navLiItem = _step.value;
